...
northern boulders at 40, and at 30 - below the barb-tailed kebbit's 33, the only prey there."""
...
failed = 0
try:
    for trap, level in (('box', '70'), ('box', '40'), ('snare', '25'), ('snare', '10'), ('deadfall', '40'), ('deadfall', '30'), ('cape', '50')):
