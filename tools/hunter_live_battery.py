...
pitfall at 40: spikes, a tease, the jump, a larupia in the pit - with the tease's level gate."""
...
failed = 0
try:
    for trap, level in (('box', '70'), ('box', '40'), ('snare', '25'), ('snare', '10'), ('deadfall', '40'), ('deadfall', '30'), ('pitfall', '40'), ('cape', '50')):
