...
~fightcave_end(sub(%fightcave_wave, 1));''',
 ...
 (SPEC, '"obj_tzhaar_cape_infernal_manwear": "7369a80ae957a12706873d0b4b714faa77e24d70"',
        '"obj_tzhaar_cape_infernal_manwear": "0000000000000000000000000000000000000000"',
  '9 obj_tzhaar_cape_infernal_manwear is the reversed-winding build'),
 ...
 (XRS2, "if (%follower_obj = $pet) {\n    return(true);\n}\n", '',
  '9 "do they have this pet" counts pack, bank and worn AND the one out following them'),
 ...
 (XRS2, 'npc_add(coord, bosspet_jalrek_jad, ^max_32bit_int);', 'npc_add(coord, bosspet_tzrek_jad, ^max_32bit_int);',
 ...
 (XRS2, 'npc_setmode(playerfollow);', 'npc_setmode(playerfollow);\ninv_add(inv, bosspet_jalrek_jad_item, 1);',
